...
import BgIMG1 from "../../../../public/7Zpq5rsCuhC8CoNtwow4eE3TemA.png"
            ...
            <div>
                ...
                <div className='relative h-auto w-screen overflow-x-hidden bg-black  text-white'>
                    <div className=' absolute h-screen overflow-hidden'>
                        <Image src={BgIMG1} alt='vi' className='h-full w-screen' />

                    </div>

                    <div className='absolute bottom-20 sm:bottom-0  left-0 z-10 flex sm:flex-row flex-col justify-between bg2 w-screen gap-10 pb-20 sm:pb-0 p-10 sm:p-32 backdrop-blur-xl'>
