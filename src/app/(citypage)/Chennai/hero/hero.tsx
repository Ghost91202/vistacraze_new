...
import BgIMG1 from "../../../../../public/chennai.jpg"
import "./style.css"
    ...
    return (
        <div className='relative z-10 h-auto w-screen overflow-x-hidden text-white'>
            ...
            {/* <div className='w-screen  h-screen lg:justify-center flex lg:items-center  sm:left-40 sm:right-0 z-0 absolute'>
                ...
                <div className='absolute bottom-0  left-0 z-10 flex  justify-between chennaibg2 w-screen gap-10 pb-20 sm:pb-0 p-10'>
                <div className='flex flex-col text-start gap-5 lg:w-96 xl:w-1/2'>
                    <h1 className='lg:text-5xl xl:text-7xl 2xl:text-7xl md:text-3xl md:bottom-0  text-3xl  font-semibold bottom-9 '>Chennai Marketing Agency</h1>
                ...
                <div className='sm:w-1/3 md:w-1/2 xl:w-1/3 font-semibold  items-start gap-10 flex-col justify-end hidden sm:flex pb-20'>
                    ...
                    <h1 className='md:text-sm lg:text-base'>We are Vistacarze, Marketing Agency that will offer you transparency and creativity.</h1>
