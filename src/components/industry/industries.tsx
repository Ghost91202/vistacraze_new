...
const industries = (props: Props) => {
  return (
      <div className=' relative bg-slate-950 z-10 flex flex-col  text-white items-center justify-center p-5 sm:p-10'>
          ...
          <div className='grid grid-cols-1 gap-5 lg:pt-10 sm:grid-cols-3 xl:p-20'>
              ...
              <div className='border border-gray-400/30 p-4 rounded-md flex flex-col items-center justify-center'>
              ...
              <div className='border border-gray-400/30 p-2 rounded-md flex flex-col items-center justify-center'>
                  <div className='p-5 flex flex-col gap-5'>
